...
export default function InstructorSignup() {
  ...
  return (
    <div className="flex flex-col gap-4 justify-center items-center">
      ...
      <button className={`w-[40%] border border-gray-900 text-gray-800 font-semibold p-2 rounded-sm mt-5 cursor-pointer hover:bg-gray-100 ${signup ? 'bg-white border-gray-900 text-gray-800 hover:bg-gray-100' : 'bg-purple-700 text-white'}
    `} onClick={() => {
        setSignup(false);
      ...
      <button className={`w-[40%] bg-purple-700 text-white font-semibold p-2 rounded-sm mt-5 ${signup ? 'bg-purple-700 text-white' : 'bg-white border border-gray-900 text-gray-800 hover:bg-gray-100'}
    `} onClick={() => {
        setSignup(true);
