...
export default function Login({handleSubmit}) {
    const setSignupData = useSetRecoilState(loginAtom);
    ...
    return (
        ...
        <button className="w-full bg-purple-700 text-white font-semibold p-3 rounded-sm mt-5" type="submit" >Log in</button>
    </form>
    )
}